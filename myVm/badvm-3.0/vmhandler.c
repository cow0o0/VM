...
void vm_init(vm_cpu *cpu)	
{
    ...
    cpu->op_list[30].handle = (void (*)(void *))vSllReg4Reg2Mem;

    cpu->op_list[30].opcode = 0x66;
    cpu->op_list[31].handle = (void (*)(void *))vXorReg4Imm2Reg;
    cpu->op_list[31].opcode = 0x67;
    cpu->op_list[32].handle = (void (*)(void *))vXorReg4Reg2Reg;
    cpu->op_list[32].opcode = 0x68;
    cpu->op_list[33].handle = (void (*)(void *))vXorReg4Mem2Reg;
    cpu->op_list[33].opcode = 0x69;
    cpu->op_list[34].handle = (void (*)(void *))vXorReg4Imm2Mem;
    cpu->op_list[35].opcode = 0x6a;
    cpu->op_list[35].handle = (void (*)(void *))vXorReg4Reg2Mem;

    cpu->op_list[36].opcode = 0x70;
    cpu->op_list[36].handle = (void (*)(void *))vAndReg4Imm2Reg;
    cpu->op_list[37].opcode = 0x71;
    cpu->op_list[37].handle = (void (*)(void *))vAndReg4Reg2Reg;
    cpu->op_list[38].opcode = 0x72;
    cpu->op_list[38].handle = (void (*)(void *))vAndReg4Mem2Reg;
    cpu->op_list[39].opcode = 0x73;
    cpu->op_list[39].handle = (void (*)(void *))vAndReg4Imm2Mem;
    cpu->op_list[40].opcode = 0x74;
    cpu->op_list[40].handle = (void (*)(void *))vAndReg4Reg2Mem;

    cpu->op_list[41].opcode = 0x80;
    cpu->op_list[41].handle = (void (*)(void *))vOrReg4Imm2Reg;
    cpu->op_list[42].opcode = 0x81;
    cpu->op_list[42].handle = (void (*)(void *))vOrReg4Reg2Reg;
    cpu->op_list[43].opcode = 0x82;
    cpu->op_list[43].handle = (void (*)(void *))vOrReg4Mem2Reg;
    cpu->op_list[44].opcode = 0x83;
    cpu->op_list[44].handle = (void (*)(void *))vOrReg4Imm2Mem;
    cpu->op_list[45].opcode = 0x84;
    cpu->op_list[45].handle = (void (*)(void *))vOrReg4Reg2Mem;

    cpu->op_list[46].opcode = 0x86;
    cpu->op_list[46].handle = (void (*)(void *))vSetLessThanImm;
    cpu->op_list[47].opcode = 0x87;
    cpu->op_list[47].handle = (void (*)(void *))vSetLessThanReg;
    cpu->op_list[48].opcode = 0x88;
    cpu->op_list[48].handle = (void (*)(void *))vBranchNotEquelZero;
    cpu->op_list[49].opcode = 0x89;
    cpu->op_list[49].handle = (void (*)(void *))vBranchNotEquelReg;
    cpu->op_list[50].opcode = 0x8a;
    cpu->op_list[50].handle = (void (*)(void *))vBranchIfEquelZero;
    cpu->op_list[51].opcode = 0x8b;
    cpu->op_list[51].handle = (void (*)(void *))vBranchIfEquelReg;

    cpu->op_list[52].opcode = 0x90;
    cpu->op_list[52].handle = (void (*)(void *))vJmp;
    cpu->op_list[53].opcode = 0x91;
    cpu->op_list[53].handle = (void (*)(void *))vNop;

    //append
    cpu->op_list[54].opcode = 0xa0;
    cpu->op_list[54].handle = (void (*)(void *))vNorReg4Imm2Reg;
    cpu->op_list[55].opcode = 0xa1;
    cpu->op_list[55].handle = (void (*)(void *))vNorReg4Reg2Reg;
    cpu->op_list[56].opcode = 0xa2;
    cpu->op_list[56].handle = (void (*)(void *))vNorReg4Mem2Reg;
    cpu->op_list[57].opcode = 0xa3;
    cpu->op_list[57].handle = (void (*)(void *))vNorReg4Imm2Mem;
    cpu->op_list[58].opcode = 0xa4;
    cpu->op_list[58].handle = (void (*)(void *))vNorReg4Reg2Mem;

    cpu->op_list[59].opcode = 0xb0;
    cpu->op_list[59].handle = (void (*)(void *))vPushImm;
    cpu->op_list[60].opcode = 0xb1;
    cpu->op_list[60].handle = (void (*)(void *))vPushMem;
    cpu->op_list[61].opcode = 0xb2;
    cpu->op_list[61].handle = (void (*)(void *))vPushReg;
    cpu->op_list[62].opcode = 0xb3;
    cpu->op_list[62].handle = (void (*)(void *))vPopImm;
    cpu->op_list[63].opcode = 0xb4;
    cpu->op_list[63].handle = (void (*)(void *))vPopMem;
    cpu->op_list[64].opcode = 0xb5;
    cpu->op_list[64].handle = (void (*)(void *))vPopReg;

    cpu->op_list[65].opcode = 0xc0;
    cpu->op_list[65].handle = (void (*)(void *))vAtomAdd;
    cpu->op_list[66].opcode = 0xc1;
    cpu->op_list[66].handle = (void (*)(void *))vAtomSub;
    cpu->op_list[67].opcode = 0xc2;
    cpu->op_list[67].handle = (void (*)(void *))vAtomAnd;
    cpu->op_list[68].opcode = 0xc3;
    cpu->op_list[68].handle = (void (*)(void *))vAtomXor;
    cpu->op_list[69].opcode = 0xc4;
    cpu->op_list[69].handle = (void (*)(void *))vAtomOr;
    cpu->op_list[70].opcode = 0xc5;
    cpu->op_list[70].handle = (void (*)(void *))vAtomNor;
    cpu->op_list[71].opcode = 0xc6;
    cpu->op_list[71].handle = (void (*)(void *))vAtomMul;
    cpu->op_list[72].opcode = 0xc7;
    cpu->op_list[72].handle = (void (*)(void *))vAtomSll;
    cpu->op_list[73].opcode = 0xc8;
    cpu->op_list[73].handle = (void (*)(void *))vAtomSra;
